    ...
    <ul class="nav nav-pills">
        <li class="active"><?php echo anchor('acoes/listar_acoes_corretivas', 'Listar') ?></li>
        <li><?php echo anchor('acoes/adicionar_acao_corretiva', 'Adicionar') ?></li>
    </ul>
    ...
    if ($this->session->userdata('acao_corretiva_excluida'))
    {
        echo '<div class="alert alert-success">'. $this->session->userdata('acao_corretiva_excluida') .'</div>';
        $this->session->unset_userdata('acao_corretiva_excluida');
    }
