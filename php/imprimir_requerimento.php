...
//        $this->SetX(-10);
        ...
        $this->MultiCell(130, 6, iconv('utf-8','iso-8859-1',"Observação: Todos os itens são de preenchimento obrigatório, exceto o campo e-mail do proprietário, de preenchimento opcional."), 0, 'C', false);
...
$html = 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
