...
class Categorias_requerimento extends MY_Controller
{
    ...
    {
        $this->data['categorias'] = $this->categoria_requerimento_model->get_categorias_with_secretarias();
    ...
    {
        $this->form_validation->set_rules($this->categoria_requerimento_model->validation);
        ...
        if ($this->form_validation->run()==TRUE):
            ...
            $next_id = $this->categoria_requerimento_model->get_next_id();
            $this->categoria_requerimento_model->relacao_secretarias($next_id, $secretarias);

            $this->categoria_requerimento_model->insert($data);
    ...
    public function editar_categoria($id)
    {
        ...
        if ($this->form_validation->run()==TRUE):
            ...
            $secretarias = $this->input->post('secretarias');            
            $this->categoria_requerimento_model->relacao_secretarias($this->input->post('id'), $secretarias);

            $this->categoria_requerimento_model->update($this->input->post('id'), $data);
        ...
        $this->data['categoria'] = $this->categoria_requerimento_model->get($id);
        $this->data['secretarias'] = $this->secretaria_model->get_all();
        $this->data['secretarias_sel'] = $this->categoria_requerimento_model->get_secretarias_by_categoria($id);
    ...
    public function excluir_categoria($id)
    {
        ...
        {
            $this->categoria_requerimento_model->delete($id);
            
            $this->categoria_requerimento_model->reordenar();
    ...
    {
        $this->categoria_requerimento_model->diminuir_ordem($id);
    ...
    {
        $this->categoria_requerimento_model->aumentar_ordem($id);
