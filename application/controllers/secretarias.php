...
class Secretarias extends MY_Controller
{
    ...
    {
        $this->form_validation->set_rules($this->secretaria_model->validation);

        if ($this->form_validation->run()==TRUE):
            $data = elements(array('nome','sigla','descricao','email','telefone'),$this->input->post());

            $this->secretaria_model->insert($data);
    ...
    public function editar_secretaria($id)
    {
        ...
        if ($this->form_validation->run()==TRUE):
            ...
            $this->secretaria_model->update($this->input->post('id'), $data);
        ...
        $this->data['secretaria'] = $this->secretaria_model->get($id);
    ...
    public function excluir_secretaria($id)
    {
        ...
        {
            $this->secretaria_model->delete($id);
