    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                echo form_open('newsletter/compor_mensagem', 'class="bs-docs-example form-horizontal" id="form" ');
                ...
                echo        form_submit('submit', 'Enviar newsletter', 'class="btn btn-primary"');
                echo        '</div>';
                echo    '</div>';
                echo '</div>';
