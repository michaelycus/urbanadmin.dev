<div class="container-fluid">
    <div id="heading" class="page-header">
        <h1><i class="icon20 i-stack-empty"></i> Compor mensagem</h1>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                echo form_open('newsletters/visualizar', 'class="bs-docs-example form-horizontal" id="form" ');
                ...
                echo        form_submit('submit', 'Salvar e Visualizar', 'class="btn btn-primary"');
                echo        '</div>';
                echo    '</div>';
                echo '</div>';
