...
<div class="container-fluid">
    <div id="heading" class="page-header">
        <h1><i class="icon20 i-people"></i> Newsletters por bairro</h1>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table cellpadding="0" cellspacing="0" border="0"
                           class="table table-striped table-bordered table-hover" id="table-mapa-newsletters">
...
<script type="text/javascript" src="<?php echo base_url() . 'js/newsletters_bairro.js'; ?>"></script>
