        $(function() {
            $(".maparea1").mapael({
                map: {
                    ...
                    defaultArea: {
                        attrs: {
                            fill: "hsl(0, 10, 84)", stroke: "#204a87"
                        },
                        text : {
                            attrs: {
                                fill: "#ce5c00",
        ...
        areas: {                        "alto_do_parque":{
                            ...
                            value: "89",
                            attrs: {
                                fill: "hsl(0, 10, 70.30755711775)", stroke: "#204a87"
                            },
                            text: { content:  89 , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Centenário </span><br />Valor: 89"},
                        },                        "centro":{
                            value: "456",
                            attrs: {
                                fill: "hsl(0, 10, 50.957820738137)", stroke: "#204a87"
                            },
                            ...
                            value: "568",
                            attrs: {
                                fill: "hsl(0, 10, 45.052724077329)", stroke: "#204a87"
                            },
                            text: { content:  568 , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Florestal </span><br />Valor: 568"},
                        },                        "hidraulica":{
                            href: "#",
                            ...
                            value: "489",
                            attrs: {
                                fill: "hsl(0, 10, 49.217926186292)", stroke: "#204a87"
                            },
                            text: { content:  489 , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Nações </span><br />Valor: 489"},
                        },                        "olarias":{
                            href: "#",
                            ...
                            value: "78",
                            attrs: {
                                fill: "hsl(0, 10, 70.887521968366)", stroke: "#204a87"
                            },
                            text: { content:  78 , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Planalto </span><br />Valor: 78"},
                        },                        "santo_andre":{
                            href: "#",
