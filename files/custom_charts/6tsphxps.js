        ...
        areas: {                        "alto_do_parque":{ 
                           value: "17",
                            attrs: {
                                fill: "hsl(53, 98, 50.714285714286)", stroke: "#204a87"
                            },
                            text: { content:  "" , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Alto do Parque </span><br />Valor: R$ 17,00"},
                        },                        "americano":{
                            href: "#",
                           ...
                           value: "14",
                            attrs: {
                                fill: "hsl(53, 98, 55)", stroke: "#204a87"
                            },
                            text: { content:  "" , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Floresta </span><br />Valor: R$ 14,00"},
                        },                        "florestal":{
                            href: "#",
                           ...
                           value: "20",
                            attrs: {
                                fill: "hsl(53, 98, 46.428571428571)", stroke: "#204a87"
                            },
                            text: { content:  "" , attrs: {fill:"#222"} },
                            href: "#",
                            tooltip: {content: "<span style=\"font-weight:bold;\">Nações </span><br />Valor: R$ 20,00"},
                        },                        "olarias":{
                            href: "#",
