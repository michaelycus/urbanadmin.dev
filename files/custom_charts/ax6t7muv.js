...
areas: {                "alto_do_parque":{ 
                   value: "45",
                    attrs: {
                        fill: "hsl(53, 98, 72.946768060837)", stroke: "#204a87"
                    },
                   ...
                   value: "11",
                    attrs: {
                        fill: "hsl(53, 98, 74.498098859316)", stroke: "#204a87"
                    },
                   ...
                   value: "55",
                    attrs: {
                        fill: "hsl(53, 98, 72.490494296578)", stroke: "#204a87"
                    },
                    text: { content:  "55" , attrs: {fill:"#222"} },
                    href: "#",
                    tooltip: {content: "<span style=\"font-weight:bold;\">Bom Pastor </span><br />Valor: 55"},
                },                "campestre":{ 
                   value: "41.5",
                    attrs: {
                        fill: "hsl(53, 98, 73.106463878327)", stroke: "#204a87"
                    },
                    text: { content:  "42" , attrs: {fill:"#222"} },
                    href: "#",
                    tooltip: {content: "<span style=\"font-weight:bold;\">Campestre </span><br />Valor: 42"},
                },                "carneiros":{ 
                   value: "656.5",
                    attrs: {
                        fill: "hsl(53, 98, 45.045627376426)", stroke: "#204a87"
                    },
                    text: { content:  "657" , attrs: {fill:"#222"} },
                    href: "#",
                    tooltip: {content: "<span style=\"font-weight:bold;\">Carneiros </span><br />Valor: 657"},
                },                "centenario":{
                    href: "#",
                   ...
                   value: "512.1",
                    attrs: {
                        fill: "hsl(53, 98, 51.634220532319)", stroke: "#204a87"
                    },
                    text: { content:  "512" , attrs: {fill:"#222"} },
                    href: "#",
                    tooltip: {content: "<span style=\"font-weight:bold;\">Centro </span><br />Valor: 512"},
                },                "conservas":{
                    href: "#",
